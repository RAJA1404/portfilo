...
export default function ProjectCaseStudyModal({
  ...
  return (
    <AnimatePresence>
      {project ? (
        <motion.div
          className="fixed inset-0 z-[90] bg-black/70 px-2 py-2 backdrop-blur-xl sm:px-6 sm:py-5"
          data-lenis-prevent
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
        ...
        >
          <motion.article
            ...
            className="mx-auto flex max-h-[calc(100dvh-1rem)] max-w-6xl flex-col overflow-hidden rounded-[1.5rem] border border-white/10 bg-[#050505] shadow-2xl shadow-blue-950/30 sm:max-h-[calc(100dvh-2.5rem)] sm:rounded-[2rem]"
          ...
          >
            <div className="flex shrink-0 items-start justify-between gap-4 border-b border-white/10 p-4 sm:gap-5 sm:p-8">
              <div>
                ...
                <h3
                  ...
                  className="mt-3 text-2xl font-semibold leading-tight text-white sm:text-5xl"
                >
                  {project.title}
                </h3>
            ...
            <div
              ...
              className="min-h-0 flex-1 touch-pan-y overflow-y-auto overscroll-contain p-4 outline-none sm:p-8"
              data-lenis-prevent
              tabIndex={0}
